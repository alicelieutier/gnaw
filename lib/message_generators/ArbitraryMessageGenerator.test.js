...
const EXPECTED_QUERY =
  "AND(DATETIME_DIFF({Send at}, 1521032816573, 'minutes') < 1, DATETIME_DIFF({Send at}, 1521032816573, 'minutes') > -15, {Sent?} = 0)";

describe("#produce", () => {
  it("returns messages for the events happening soon", async () => {
